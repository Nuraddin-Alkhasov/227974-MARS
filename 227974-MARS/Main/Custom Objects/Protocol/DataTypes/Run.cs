...
namespace HMI.CO.Protocol
{
    ...
    public class Run
    {
        ...
        public void FillPZTrend(int PZTrend_Id)
        {
            Trend temp = new Trend();
            DataTable DT = new MSSQLEAdapter("Orders", "Select * From Trends WHERE Id = " + PZTrend_Id).DB_Output();
            Thread.Sleep(20);
            if (DT.Rows.Count > 0)
            {
                temp = new Trend()
        ...
        public void FillWZTrend(int WZTrend_Id)
        {
            Trend temp = new Trend();
            DataTable DT = new MSSQLEAdapter("Orders", "Select * From Trends WHERE Id = " + WZTrend_Id).DB_Output();
            Thread.Sleep(20);
            if (DT.Rows.Count > 0)
            {
                temp = new Trend()
        ...
        public void FillHZTrend(int HZTrend_Id)
        {
            Trend temp = new Trend();
            DataTable DT = new MSSQLEAdapter("Orders", "Select * From Trends WHERE Id = " + HZTrend_Id).DB_Output();
            Thread.Sleep(20);
            if (DT.Rows.Count > 0)
            {
                temp = new Trend()
        ...
        public void FillCZTrend(int CZTrend_Id)
        {
            Trend temp = new Trend();
            DataTable DT = new MSSQLEAdapter("Orders", "Select * From Trends WHERE Id = " + CZTrend_Id).DB_Output();
            Thread.Sleep(20);
            if (DT.Rows.Count > 0)
            {
                temp = new Trend()
