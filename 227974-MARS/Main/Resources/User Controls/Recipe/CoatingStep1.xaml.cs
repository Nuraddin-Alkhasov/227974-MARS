...
namespace HMI.Resources.UserControls
{
    public partial class CoatingStep1 : UserControl
    {
        public CoatingStep1()
        {
            ...
            InitializeComponent();
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Type", 1);
        }
        ...
        private void Astraight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Dip Time", 0);
        ...
        private void A50_Click(object sender, RoutedEventArgs e)
        {
            ...
            border1.Visibility = Visibility.Collapsed;
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Time Straight", 0);
        ...
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Angle", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Change of Direction", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Dip Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Draining Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Rotation Speed", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Time Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Vat identifier", 0);
        }
        private void ResetSpinning()
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.1.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.1.Rotor Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.2.Planet RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.2.Planet Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.2.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.3.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Spinning.3.Rotor Time", 0);
        }
        #endregion
