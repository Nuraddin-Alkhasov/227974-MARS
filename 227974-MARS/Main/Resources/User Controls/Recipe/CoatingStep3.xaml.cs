...
namespace HMI.Resources.UserControls
{
    public partial class CoatingStep3 : UserControl
    {
        public CoatingStep3()
        {
            ...
            InitializeComponent();
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Type", 0);
        }
        ...
        private void Astraight_Click(object sender, RoutedEventArgs e)
        {
            ...
            dtime.RawLimitMin = 5;
            dtime.RawLimitMax = 59;
            dtime.Visibility = Visibility.Collapsed;

            drtime.RawLimitMin = 0;
            drtime.RawLimitMax = 59;

            border1.Visibility = Visibility.Collapsed;
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Dip Time", 0);
        ...
        private void A50_Click(object sender, RoutedEventArgs e)
        {
            ...
            border1.Visibility = Visibility.Collapsed;
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Time Straight", 0);
        ...
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Angle", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Change of Direction", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Dip Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Draining Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Rotation Speed", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Time Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Dipping.Vat identifier", 0);
        }
        private void ResetSpinning()
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.1.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.1.Rotor Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.2.Planet RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.2.Planet Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.2.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.3.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[2].Spinning.3.Rotor Time", 0);
        }
        #endregion

        private void dtime_ValueChanged(object sender, VisiWin.DataAccess.VariableEventArgs e)
        {
            if (angle.Value == 50) 
            {
                if ((short)e.Value == 0)
