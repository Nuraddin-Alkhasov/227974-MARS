        ...
        public Coating Coating
        {
            set
            {
                ...
                if (coating != null)
                {
                    ...
                    {
                           VWVariable aa = value.VWRecipe.VWVariables.First(x => x.Item.ToString() == "CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[0].Dipping.Vat identifier");
