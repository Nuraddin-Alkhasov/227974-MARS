...
namespace HMI.Resources.UserControls
{
    public partial class CoatingStep4 : UserControl
    {
        public CoatingStep4()
        {
            ...
            InitializeComponent();
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Type", 0);
        }
        ...
        private void Astraight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Dip Time", 0);
        ...
        private void A50_Click(object sender, RoutedEventArgs e)
        {
            ...
            border1.Visibility = Visibility.Collapsed;
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Time Straight", 0);
        ...
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Angle", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Change of Direction", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Dip Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Draining Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Rotation Speed", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Time Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Dipping.Vat identifier", 0);
        }
        private void ResetSpinning()
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.1.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.1.Rotor Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.2.Planet RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.2.Planet Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.2.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.3.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Station.Step[3].Spinning.3.Rotor Time", 0);
        }
        #endregion
