...
{
    public partial class MV_TH : UserControl
    {
        public MV_TH()
        {
            InitializeComponent();
            Traction = "CPU2.PLC.Blocks.01 Tray Handling.02 TH.01 Traction.DB TH Traction HMI.Actual.Traction.Motor.Actual.Position in units";
