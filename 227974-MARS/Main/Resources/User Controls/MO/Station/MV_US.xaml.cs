...
namespace HMI.Resources.UserControls.MO
{
    public partial class MV_US : UserControl
    {
        ...
        {
            InitializeComponent();
            isBox1 = "CPU2.PLC.Blocks.01 Tray Handling.05 PO.04 Unload 1.00 Main.DB US Box 1 PD.Box.isBox";
            isMaterialBox1 = "CPU2.PLC.Blocks.01 Tray Handling.05 PO.04 Unload 1.00 Main.DB US Box 1 PD.Charge.isMaterial";
            isBox2 = "CPU2.PLC.Blocks.01 Tray Handling.05 PO.05 Unload 2.00 Main.DB US Box 2 PD.Box.isBox";
            isMaterialBox2 = "CPU2.PLC.Blocks.01 Tray Handling.05 PO.05 Unload 2.00 Main.DB US Box 2 PD.Charge.isMaterial";
            isBox1Full = "CPU2.PLC.Blocks.01 Tray Handling.05 PO.04 Unload 1.Belt.DB US 1 Belt HMI.Actual.Box.Needs to be changed";
            isBox2Full = "CPU2.PLC.Blocks.01 Tray Handling.05 PO.05 Unload 2.Belt.DB US 2 Belt HMI.Actual.Box.Needs to be changed";
        }
