                ...
                if (!Equals(value, selectedRun))
                {
                    ...
                    if (selectedRun != null)
                    {
                        ...
                        Task obTask = Task.Run(() =>
                        {
                            ...
                            selectedRun.FillPZTrend(selectedRun.PZTrend_Id);
                            selectedRun.FillWZTrend(selectedRun.WZTrend_Id);
                            selectedRun.FillHZTrend(selectedRun.HZTrend_Id);
                            selectedRun.FillCZTrend(selectedRun.CZTrend_Id);
                        });
                        obTask.ContinueWith(x =>
                        {
                            Application.Current.Dispatcher.Invoke(delegate
