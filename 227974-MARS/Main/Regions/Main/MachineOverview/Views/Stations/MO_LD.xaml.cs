...
namespace HMI.MainRegion.MO.Views
{
    ...
    public partial class MO_LD 
    {
        ...
        public MO_LD()
        {
            ...
            Weight = "CPU1.PLC.Blocks.01 Basket feeding.03 DC.DB DC PD.Station.Feeding.BS.Weight";
        ...
        private void IVWeight_ValueChanged(object sender, VariableEventArgs e)
        {
            if (e.Quality.Data == DataQuality.Good)
            {
                ...
                t_weight.Value = (float)e.Value + (float)ApplicationService.GetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.04 BS.DB BS HMI.Parameters.Weight.Overweight");
            }
        }
        ...
        private void update_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Handshake.from PC.Reload", 1);
