...
namespace HMI.DialogRegion.MO.Adapters
{
    ...
    public class MO_CoatingPicker : AdapterBase
    {
        ...
        private void LoadExecuted(object parameter)
        {
            ...
            ApplicationService.SetVariableValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC PD.Charge.Layers.Actual", 0);
            ApplicationService.SetVariableValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC PD.Header.Data.MRId", C.Header.Id);
            ApplicationService.SetVariableValue("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.PC.Handshake.to PC.GetRecipe", true);
