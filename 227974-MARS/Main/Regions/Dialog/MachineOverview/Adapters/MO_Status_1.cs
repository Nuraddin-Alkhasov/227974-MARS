...
;                switch (SPData.Type)
            ...
            try
            {
                ...
                if (MR.Header.Id > 0)
                {
                    ...
                    if (DT.Rows.Count > 0)
                    {
                        ...
                        Layers[0] = (int)DT.Rows[0]["C1_P"] != -1 ? ApplicationService.GetVariableValue("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name[" + (int)DT.Rows[0]["C1_P"] + "]").ToString() : " - - - ";
                        Layers[1] = (int)DT.Rows[0]["C2_P"] != -1 ? ApplicationService.GetVariableValue("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name[" + (int)DT.Rows[0]["C2_P"] + "]").ToString() : " - - - ";
                        Layers[2] = (int)DT.Rows[0]["C3_P"] != -1 ? ApplicationService.GetVariableValue("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name[" + (int)DT.Rows[0]["C3_P"] + "]").ToString() : " - - - ";
                        Layers[3] = (int)DT.Rows[0]["C4_P"] != -1 ? ApplicationService.GetVariableValue("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name[" + (int)DT.Rows[0]["C4_P"] + "]").ToString() : " - - - ";
                        Layers[4] = (int)DT.Rows[0]["C5_P"] != -1 ? ApplicationService.GetVariableValue("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name[" + (int)DT.Rows[0]["C5_P"] + "]").ToString() : " - - - ";
                        for (int i = 1; i <= 5; i++)
                        {
        ...
        private StateCollection GetPaintTypes()
        {
            ...
            for (int i = 1; i <= 10; i++)
            {
                ...
                string temp = ApplicationService.GetVariableValue("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name[" + i + "]").ToString();
                if (temp != "")
                {
                    Temp_SC.Add(new State()
                    {
