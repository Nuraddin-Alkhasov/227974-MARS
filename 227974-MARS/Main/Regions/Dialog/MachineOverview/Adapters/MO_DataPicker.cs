...
namespace HMI.DialogRegion.MO.Adapters
{
    ...
    public class MO_DataPicker : AdapterBase
    {
        ...
        private void LoadExecuted(object parameter)
        {
            ...
            if (ManualMode)
            {
                ApplicationService.SetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 1#STRING10", Data1);
                //ApplicationService.SetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 2#STRING10", Data2);
                //ApplicationService.SetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 3#STRING10", Data3);
        ...
        protected override void OnViewLoaded(object sender, ViewLoadedEventArg e)
        {
            ...
            Data1 = ApplicationService.GetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 1#STRING10").ToString();
            Data2 = ApplicationService.GetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 2#STRING10").ToString();
            Data3 = ApplicationService.GetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 3#STRING10").ToString();
