...
namespace HMI.DialogRegion.MO.Views
{
    ...
    public partial class MO_Coating_SF
    {
        ...
        private void View_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            VStatus = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.Actual.Motor Box Air.Ventilator");
            VStatus.Change += VStatus_Change;

            VPurge = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.Actual.Motor Box Air.Purge time acitive");
            VPurge.Change += VPurge_Change;

            VPS1 = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.Actual.Motor Box Air.Pressure switch 1");
            VPS1.Change += VPS1_Change;

            VPS2 = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC HMI.Actual.Motor Box Air.Pressure switch 2");
