...
namespace HMI.DialogRegion.MO.Views
{
    ...
    public partial class MO_HZ_EF
    {
        ...
        private void View_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            VPS1 = VS.GetVariable("CPU2.PLC.Blocks.05 Airflow Heating.01 PZ.DB PZ Air HMI.Actual.Exhaust air.State.Pressure switch 1");
            VPS1.Change += VPS1_Change;

            VPS2 = VS.GetVariable("CPU2.PLC.Blocks.05 Airflow Heating.01 PZ.DB PZ Air HMI.Actual.Exhaust air.State.Pressure switch 2");
