...
namespace HMI.Services
{
    ...
    class Service_Protocol : ServiceBase, IProtocol
    {
        ...
        protected override void OnLoadProjectCompleted()
        {
            ...
            {
                Data_1 = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 1#STRING10"),
                Data_2 = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 2#STRING10"),
                Data_3 = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.Data.to.Data 3#STRING10"),
            ...
            NC = new NewCharge("CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.Protocol.NewCharge")
            {
                ...
                WeightL = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.04 BS.DB BS PD.Charge.Weight.Left"),
                WeightR = VS.GetVariable("CPU1.PLC.Blocks.01 Basket feeding.04 BS.DB BS PD.Charge.Weight.Right"),
                ...
                "CPU1.PLC.Blocks.00 Main.02 HMI.01 PC.DB PC.Protocol.Coating.isFault")
            {
                ...
                Run_Id = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC PD.Header.RunId"),
                MR_Id = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC PD.Header.MRId"),
                ActualLayer= VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.00 Main.DB BC PD.Charge.Layers.Actual"),
                SetPaintTemp = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT HMI.Actual.Dipping Vat.Set Paint Temp"),
                ActualPaintTemp = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT HMI.Actual.Dipping Vat.Act Paint Temp"),
                PaintType = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT HMI.Actual.Dipping Vat.Paint Type"),

                Paints = "CPU1.PLC.Blocks.03 Basket coating.10 DT.DB DT Parameter.Name",
                StartError = 1521,
                EndError = 2032
            ...
            //    },
            //    TH_Run_Id = VS.GetVariable("CPU2.PLC.Blocks.01 Tray Handling.02 TH.00 Main.DB TH PD.Header.RunId"),
